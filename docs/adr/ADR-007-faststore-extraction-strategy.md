...
El repositorio de referencia se mantiene externo en `https://github.com/jairocalle4/ERP-STORE-FAST-ConFirmaElectronica.git` y no se incluirá como submódulo. Los componentes se extraerán de forma manual según sea necesario en los siguientes sprints.
